...
export const learningService = {
  ...
  completeCourse: (courseId: string): Promise<Enrollment> => {
    return apiClient<Enrollment>(`/learning/api/v1/courses/${courseId}/complete`, {
      method: 'POST',
    });
  },

  getCertificates: (params?: ListParams): Promise<PageResponse<Certificate>> => {
    return getPage<Certificate>('/learning/api/v1/certificates', params);
  },
